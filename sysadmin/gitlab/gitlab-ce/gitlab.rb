...
external_url 'https://gitlab.sergeant.work'
...
################################################################################
# gitlab_rails['gitlab_ssh_host'] = 'ssh.host_sergeant.work'
...
gitlab_rails['smtp_domain'] = "sergeant.work"
...
##! If your SMTP server does not like the default 'From: gitlab@gitlab.sergeant.work'
##! can change the 'From' with this setting.
# gitlab_rails['gitlab_email_from'] = 'example@sergeant.work'
# gitlab_rails['gitlab_email_display_name'] = 'Example'
# gitlab_rails['gitlab_email_reply_to'] = 'noreply@sergeant.work'
...
###! install
# gitlab_rails['mattermost_host'] = "https://mattermost.sergeant.work"
...
# gitlab_rails['smartcard_client_certificate_required_host'] = 'smartcard.gitlab.sergeant.work'
...
# gitlab_rails['forti_authenticator_host'] = 'forti_authenticator.sergeant.work'
...
# registry_external_url 'https://registry.sergeant.work'

### Settings used by GitLab application
# gitlab_rails['registry_enabled'] = true
# gitlab_rails['registry_host'] = "registry.gitlab.sergeant.work"
...
#   {
#     'name' => 'test_endpoint',
#     'url' => 'https://gitlab.sergeant.work/notify2',
#     'timeout' => '500ms',
#     'threshold' => 5,
#     'backoff' => '1s',
#     'headers' => {
...
# pages_external_url "https://pages.sergeant.work/"
...
# gitlab_rails['gitlab_kas_external_url'] = 'ws://gitlab.sergeant.work/-/kubernetes-agent/'
# gitlab_rails['gitlab_kas_internal_url'] = 'grpc://localhost:8153'
# gitlab_rails['gitlab_kas_external_k8s_proxy_url'] = 'https://gitlab.sergeant.work/-/kubernetes-agent/'
...
mattermost_external_url 'https://mattermost.sergeant.work'
...
# mattermost['gitlab_auth_endpoint'] = "http://gitlab.sergeant.work/oauth/authorize"
# mattermost['gitlab_token_endpoint'] = "http://gitlab.sergeant.work/oauth/token"
# mattermost['gitlab_user_api_endpoint'] = "http://gitlab.sergeant.work/api/v4/user"
...
# alertmanager['admin_email'] = 'admin@sergeant.work'
# alertmanager['flags'] = {
...
#   'from_name' => 'Grafana',
#   'ehlo_identity' => 'dashboard.sergeant.work',
#   'startTLS_policy' => nil
# }
...
# gitlab_rails['kerberos_service_principal_name'] = HTTP/gitlab.sergeant.work@EXAMPLE.COM
# gitlab_rails['kerberos_simple_ldap_linking_allowed_realms'] = ['sergeant.work','kerberos.sergeant.work']
...
################################################################################
# gitlab_rails['db_load_balancing'] = { 'hosts' => ['secondary1.sergeant.work'] }
...
# gitlab_rails['geo_registry_replication_primary_api_url'] = 'https://sergeant.work:5050'
